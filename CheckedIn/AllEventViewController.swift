...
class AllEventViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.eventTitleLabel.text = "iOS Oberserver class and this is a pretty long event name!"
        cell.eventLocationLabel.text = "Palo Alto, CA"
        cell.eventTimeLabel.text = "FRIDAY NOV 4 @10:00PM"
